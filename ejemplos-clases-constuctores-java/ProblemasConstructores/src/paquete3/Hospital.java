...
public class Hospital {
    ...
    public String toString() {
        /*
        El String format en este caso para que presente el texto en el main
        se le puede dar tanto los metodos obtener, como directamente el atributo
        siempre y cuando estemos trabajando dentro de la clase
        */
